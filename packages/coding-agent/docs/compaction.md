...
For TypeScript definitions in your project, inspect `node_modules/@a5345534/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@a5345534/pi-coding-agent";
