...
```typescript
import type { ExtensionAPI } from "@a5345534/pi-coding-agent";
...
| Package | Purpose |
|---------|---------|
| `@a5345534/pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
...
```typescript
import { isToolCallEventType } from "@a5345534/pi-coding-agent";
...
```typescript
import { isBashToolResult } from "@a5345534/pi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@a5345534/pi-coding-agent";
...
```typescript
import { SessionManager } from "@a5345534/pi-coding-agent";
...
```typescript
import { withFileMutationQueue } from "@a5345534/pi-coding-agent";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@a5345534/pi-coding-agent";
...
```typescript
import { createBashTool } from "@a5345534/pi-coding-agent";
...
```typescript
import { keyHint } from "@a5345534/pi-coding-agent";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@a5345534/pi-coding-agent";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@a5345534/pi-coding-agent";
