...
// ============================================================================
// OAuth API key resolution from ~/.pi-fork/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".pi-fork", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.pi-fork/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.pi-fork/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".pi-fork", "agent");

/**
 * Get an AuthStorage instance backed by ~/.pi-fork/agent/auth.json
