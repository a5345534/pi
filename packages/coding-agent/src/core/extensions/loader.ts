...
// avoiding a circular dependency. Extensions can import from @a5345534/pi-coding-agent.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@a5345534/pi-coding-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	_aliases = {
		"@a5345534/pi-coding-agent": piCodingAgentEntry,
